...
import static com.murad.util.LoggerUtil.LOG;
...
public class DecoratorPatternDriver {
    ...
    public static void main(String[] args) {
        ...
        ChristmasTree tree3 = new BubbleLights(new Garland(new BubbleLights(new ChristmasTreeImpl())));
        LOG.info(tree3.decorate());
